...
>在[上篇文章](http://langziliu.github.io/2016/12/26/ReactiveCocoa-基础/)中介绍了**ReactiveCocoa**的基础知识,接下来我们来深入介绍**ReactiveCocoa**及其在**MVVM**中的用法。
...
>最后附上GitHub：<https://github.com/langziliu/ReactiveCocoa_Demo>
